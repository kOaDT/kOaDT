...
| CVE | Description | ⭐ | 🍴 | 👁️ | 📥 |
|:----|:------------|---:|---:|----:|---:|
| [**CVE-2025-55182**](https://github.com/kOaDT/poc-cve-2025-55182) | This repository contains a POC of CVE-2025-55182, a critical (CVSS score 10.0) pre-authentication remote code execution vulnerability affecting React Server Components, also known as React2Shell. | 15 | 3 | 5338 | 1629 |
| [**CVE-2025-29927**](https://github.com/kOaDT/poc-cve-2025-29927) | This repository contains a POC and an exploit script for CVE-2025-29927, a critical vulnerability in Next.js that allows attackers to bypass authorization checks implemented in middleware. | 8 | 3 | 2191 | 804 |
| [**CVE-2026-32255**](https://github.com/kOaDT/poc-cve-2026-32255) | This repository contains a proof of concept (POC) for CVE-2026-32255, a high-severity Server-Side Request Forgery (SSRF) vulnerability in Kan, an open-source project management tool. | 2 | - | 998 | 307 |
...
|:--------|:------------|---:|---:|----:|---:|
| [**oss-oopssec-store**](https://github.com/kOaDT/oss-oopssec-store) | Security training for the apps you actually ship. Open your browser and start hacking. | 33 | 43 | 5690 | 52170 |
| [**cyber-bot**](https://github.com/kOaDT/cyber-bot) | Threat intelligence platform: RSS aggregation, NVD CVE tracking, ENISA EUVD, databreaches, ... | 5 | 1 | 261537 | 1953 |
| [**hate-crimes-map**](https://github.com/kOaDT/hate-crimes-map) | This project aims to visualize hate crime data to bring visibility to crimes that are often invisible or normalized by society. | 3 | - | 154 | 487 |
| [**awesome-pentest-tools**](https://github.com/kOaDT/awesome-pentest-tools) | Open-source offensive security tools, plus a vendor-agnostic AI agent that runs authorized pentest engagements using only tools from this list. | 3 | 2 | 29 | 235 |
| [**crack-hash**](https://github.com/kOaDT/crack-hash) | A fast, multi-threaded hash cracking tool written in Rust. This tool performs dictionary attacks against hashed passwords. | 2 | - | 75 | 55 |
...
<!-- OSS_START -->
<details>
<summary><b>OSS Contributions (20)</b></summary>
<br>

| Repository | Description | ⭐ | 🍴 |
|:-----------|:------------|---:|---:|
| [**kanbn/kan**](https://github.com/kanbn/kan) | The open source Trello alternative. | 5293 | 433 |
| [**ThePorgs/Exegol**](https://github.com/ThePorgs/Exegol) | Fully featured and community-driven hacking environment | 3022 | 279 |
| [**beelzebub-labs/beelzebub**](https://github.com/beelzebub-labs/beelzebub) | A secure low code deception runtime framework, leveraging AI for System Virtualization. | 2124 | 205 |
| [**OWASP/www-community**](https://github.com/OWASP/www-community) | OWASP Community Pages are a place where OWASP can accept community contributions for security-related content. | 1390 | 841 |
| [**OWASP/www-project-vulnerable-web-applications-directory**](https://github.com/OWASP/www-project-vulnerable-web-applications-directory) | The OWASP Vulnerable Web Applications Directory Project (VWAD) is a comprehensive and well maintained registry of all known vulnerable web applications currently available. | 90 | 50 |
| [**nilbuild/developer-roadmap**](https://github.com/nilbuild/developer-roadmap) | Interactive roadmaps, guides and other educational content to help developers grow in their careers. | 363418 | 44715 |
| [**usebruno/bruno**](https://github.com/usebruno/bruno) | Opensource IDE For Exploring and Testing API's (lightweight alternative to Postman/Insomnia) | 46083 | 2745 |
| [**enaqx/awesome-pentest**](https://github.com/enaqx/awesome-pentest) | A collection of awesome penetration testing resources, tools and other shiny things | 26793 | 4894 |
| [**qazbnm456/awesome-web-security**](https://github.com/qazbnm456/awesome-web-security) | 🐶 A curated list of Web Security materials and resources. | 13641 | 1803 |
| [**infoslack/awesome-web-hacking**](https://github.com/infoslack/awesome-web-hacking) | A list of web application security | 7212 | 1351 |
| [**satnaing/astro-paper**](https://github.com/satnaing/astro-paper) | A minimal, accessible and SEO-friendly Astro blog theme. | 4913 | 1046 |
| [**husnainfareed/awesome-ethical-hacking-resources**](https://github.com/husnainfareed/awesome-ethical-hacking-resources) | 😎 🔗 Awesome list about all kinds of resources for learning Ethical Hacking and Penetration Testing. | 3680 | 559 |
| [**lingdojo/kana-dojo**](https://github.com/lingdojo/kana-dojo) | Aesthetic, minimalist platform for learning Japanese inspired by Duolingo and Monkeytype, built with Next.js and sponsored by Vercel. Beginner-friendly with plenty of good first issues - all contributions are welcome! | 3098 | 2915 |
| [**fabionoth/awesome-cyber-security**](https://github.com/fabionoth/awesome-cyber-security) | A collection of awesome software, libraries, documents, books, resources and cools stuffs about security. | 1916 | 262 |
| [**vavkamil/awesome-vulnerable-apps**](https://github.com/vavkamil/awesome-vulnerable-apps) | Awesome Vulnerable Applications | 1459 | 225 |
| [**kaiiyer/awesome-vulnerable**](https://github.com/kaiiyer/awesome-vulnerable) | A curated list of VULNERABLE APPS and SYSTEMS which can be used as PENETRATION TESTING PRACTICE LAB. | 1371 | 225 |
| [**Grafikart/Grafikart.fr**](https://github.com/Grafikart/Grafikart.fr) | Dépôt pour la nouvelle version de Grafikart.fr | 690 | 189 |
| [**okhosting/awesome-cyber-security**](https://github.com/okhosting/awesome-cyber-security) | A curated list of cyber security resources and tools. | 672 | 108 |
| [**noraj/rawsec-cybersecurity-inventory**](https://github.com/noraj/rawsec-cybersecurity-inventory) | An inventory of tools and resources about CyberSecurity that  aims to help people to find everything related to CyberSecurity. | 341 | 74 |
...
| 226 | [Phishing Basics](https://tryhackme.com/room/phishingbasics) | easy |
...
| 232 | [Cyber Kill Chain](https://tryhackme.com/room/cyberkillchain) | medium |
...
| 237 | [The Building Blocks of AI](https://tryhackme.com/room/aimlsecuritythreats) | easy |
| 238 | [CAPTCHApocalypse](https://tryhackme.com/room/captchapocalypse) | medium |
...
| 241 | [AI Forensics](https://tryhackme.com/room/aiforensics) | medium |
| 242 | [Extract](https://tryhackme.com/room/extract) | hard |
| 243 | [Cipher's Secret Message](https://tryhackme.com/room/hfb1cipherssecretmessage) | easy |
| 244 | [Evil-GPT](https://tryhackme.com/room/hfb1evilgpt) | easy |
| 245 | [Evil-GPT v2](https://tryhackme.com/room/hfb1evilgptv2) | easy |
| 246 | [Sequence](https://tryhackme.com/room/sequence) | medium |
| 247 | [Roundcube: CVE-2025-49113](https://tryhackme.com/room/roundcubecve202549113) | easy |
...
| 318 | [Walking An Application](https://tryhackme.com/room/walkinganapp) | easy |
| 319 | [Defensive Security Intro](https://tryhackme.com/room/defensivesecurityintroezn39) | info |
| 320 | [AI Threat Modelling](https://tryhackme.com/room/aithreatmodelling) | medium |
| 321 | [Securing AI Systems](https://tryhackme.com/room/securingaisystems) | medium |
| 322 | [CSRF Introduction](https://tryhackme.com/room/csrfintroduction) | easy |
| 323 | [AI System Reconnaissance](https://tryhackme.com/room/aisystemreconnaissance) | medium |
| 324 | [Penetration Testing Frameworks](https://tryhackme.com/room/penetrationtestingframeworks) | easy |
| 325 | [Guided Pentest: Infrastructure](https://tryhackme.com/room/guidedpentestinfrastructure) | easy |
| 326 | [XSS Introduction](https://tryhackme.com/room/xssintroduction) | medium |
| 327 | [SQL Injection Introduction](https://tryhackme.com/room/sqlinjectionintroduction) | easy |
| 328 | [Guided Pentest: Web](https://tryhackme.com/room/guidedpentestweb) | easy |
| 329 | [Web Server Attacks - I](https://tryhackme.com/room/webserverattacks) | medium |
